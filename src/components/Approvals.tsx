      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-display font-bold tracking-tight uppercase text-[10px] tracking-widest text-brand-orange">Pending Payments ({pending.payments.length})</h2>
          </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-display font-bold tracking-tight uppercase text-[10px] tracking-widest text-brand-orange">Pending Expenses ({pending.expenses.length})</h2>
          </div>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] uppercase font-bold text-slate-300 tracking-widest">{expense.category}</p>
                      </div>
                    </div>
                  </div>
