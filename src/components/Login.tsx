...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F2ED] flex items-center justify-center p-6 font-sans">
      <div className="w-full max-w-[1000px] bg-white rounded-[3rem] overflow-hidden shadow-2xl flex flex-col md:flex-row border border-black/5">
        <div className="flex-1 p-10 md:p-20 relative overflow-hidden bg-[#1A1A1A] text-white flex flex-col justify-between">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[#5A5A40] rounded-full blur-[120px] opacity-20 -mr-48 -mt-48" />
          ...
          <div className="relative z-10 pt-10 border-t border-white/5 flex items-center justify-between">
            <div className="flex -space-x-4">
              {[1, 2, 3].map(i => (
                <div key={i} className="w-10 h-10 rounded-full border-2 border-[#1A1A1A] bg-[#5A5A40] flex items-center justify-center text-[10px] font-bold">
                  {i}
                </div>
              ))}
            </div>
            <p className="text-[10px] uppercase tracking-widest opacity-30 font-bold mx-4">Internal Property Portfolio Management</p>
          </div>
        </div>
        ...
        <div className="flex-1 p-10 md:p-20 bg-white">
          <div className="max-w-sm mx-auto">
            ...
            <p className="text-black/40 text-sm font-medium mb-10">Enter your credentials to access the console.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-14 pr-6 py-5 bg-black/5 border-none rounded-2xl text-sm font-medium focus:ring-2 ring-[#5A5A40]/20 transition-all outline-none" 
              ...
              <div className="space-y-2">
                <div className="flex justify-between ml-1">
                  ...
                  <button type="button" className="text-[10px] font-bold uppercase tracking-widest text-[#5A5A40] hover:underline">Forgot?</button>
                </div>
                <div className="relative">
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full group mt-4 py-5 bg-[#1A1A1A] text-white rounded-2xl font-bold flex items-center justify-center gap-3 hover:bg-[#5A5A40] transition-all disabled:opacity-50 shadow-xl shadow-black/10"
              >
